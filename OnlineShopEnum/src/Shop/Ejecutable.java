...
public class Ejecutable {
    ...
    private static void elegirProd(Scanner t, Venta v) {
        ...
        if (rta == 3) {
          p=  crearAccesorio(t,v);
        }
        v.agregarProducto(p);
    }
    
    private static Producto crearPantalon(Scanner t, Venta v){
        System.out.println("-------------------------------------------------------------------------");
        int talla;
    ...
    private static Producto crearRemera(Scanner t, Venta v){
        System.out.println("-------------------------------------------------------------------------");
        char talle;
    ...
    private static Producto crearAccesorio(Scanner t, Venta v){
        System.out.println("-------------------------------------------------------------------------");
        double peso;
